...
cdef class NewGcsClient:
    ...
    def async_internal_kv_get(
        ...
        with nogil:
            check_status(self.inner.get().InternalKV().AsyncInternalKVGet(
    ...
    def async_internal_kv_multi_get(
        ...
        cdef PyDefaultCallback cy_callback = PyDefaultCallback(cb)
        with nogil:
            check_status(self.inner.get().InternalKV().AsyncInternalKVMultiGet(
    ...
    def async_internal_kv_put(
        ...
        cdef PyDefaultCallback cy_callback = PyDefaultCallback(cb)
        with nogil:
            check_status(self.inner.get().InternalKV().AsyncInternalKVPut(
    ...
    def async_internal_kv_del(self, c_string key, c_bool del_by_prefix,
        ...
        cdef PyDefaultCallback cy_callback = PyDefaultCallback(cb)
        with nogil:
            check_status(self.inner.get().InternalKV().AsyncInternalKVDel(
    ...
    def async_get_all_job_info(
        ...
        cdef PyDefaultCallback cy_callback = PyDefaultCallback(cb)
        with nogil:
            check_status(self.inner.get().Jobs().AsyncGetAll(cy_callback, timeout_ms))
        return fut
