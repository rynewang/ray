...
Status ConnectOnDedicatedIoContext(GcsClient &gcs_client, int64_t timeout_ms) {
  static DedicatedIoContextThread dedicated_io_thread("singleton_io_context.gcs_client");
  return gcs_client.Connect(dedicated_io_thread.GetIoContext(), timeout_ms);
}
